...
function LandingPage() {
  useEffect(() => {
    ...
    const landingButton = document.querySelectorAll(".primary-action-btn");
    ...
    <>
      ...
      <section className="landing-page">
        ...
        <div className="landing-content">
          <h2 id="landing-char">THIS IS</h2>
          <h1 id="landing-char">FGraphs</h1>
          <h3 id="landing-char">A simplistic take on fitness tracking</h3>
          <p id="landing-char">
